    ...
    return (
        <div className="flex flex-col gap-6 p-4 ">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
                <Stat icon={<BookOpen className="size-5" />} label="Enrolled" value={courses.length} />
                <Stat icon={<CheckCircle className="size-5" />} label="Completed" value={completed.length} />
                <Stat icon={<Clock className="size-5" />} label="Total Hours" value={`${totalHours}h`} />
                <Stat icon={<Trophy className="size-5" />} label="Certificates" value={completed.length} />
            </div>
