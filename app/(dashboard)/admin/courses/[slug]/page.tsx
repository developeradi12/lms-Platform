...
//       const res = await apiget(`/api/admin/courses/${slug}`)
...
//       await apipost(`/api/admin/courses/${slug}/chapters`, {
//         title: chapterTitle,
//       })
...
//       await apipost(`/api/admin/courses/${slug}/chapters/${chapterId}/lessons`, {
//         title,
//       })
