...
export default function EditLessonPage() {
    ...
    useEffect(() => {
        ...
        const fetchLesson = async () => {
            try {
                const res = await axios.get(`/api/admin/courses/${slug}/chapters/${chapterId}/lessons/${lessonId}`)
    ...
    const onSubmit = async (values: FormValues) => {
        try {
            ...
            const res = await axios.patch(`/api/admin/courses/${slug}/chapters/${chapterId}/lessons/${lessonId}`, payload)
